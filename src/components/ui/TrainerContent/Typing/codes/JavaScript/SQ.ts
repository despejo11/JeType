import { TJavaScriptSQOne, TJavaScriptSQTwo, TJavaScriptSQThree } from './types'

export const SQ: {
  JavaScriptSQOne: TJavaScriptSQOne
  JavaScriptSQTwo: TJavaScriptSQTwo
  JavaScriptSQThree: TJavaScriptSQThree
} = {
  JavaScriptSQOne: {
